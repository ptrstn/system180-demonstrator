...
echo "✅ custom_320_FP16_detect.engine      (für CENTER_1)"
echo "✅ NubsUpDown_320_FP16_segment.engine (für LEFT & RIGHT)" 
echo "✅ synthetic_320_FP16_detect.engine   (für CENTER_2)"
echo ""
