...
OAK_FPS:                int   = 30
YOLO_ENGINE_LEFT:       str   = "./models/NubsUpDown_320_FP16_segment_retrained.engine"
YOLO_ENGINE_RIGHT:      str   = "./models/NubsUpDown_320_FP16_segment_retrained.engine"
...
YOLO_ENGINE_CENTER_1:   str   = "./models/custom_320_FP16_detect_retrained.engine"
YOLO_ENGINE_CENTER_2:   str   = "./models/synthetic_320_FP16_detect_retrained.engine"
